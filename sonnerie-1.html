...
<head>
    ...
    <title>Projet de Changement de Sonnerie du Lycée</title>
    <style>
        body {
        ...
        .section {
            margin-bottom: 30px;
            background-color: #e9f7fa; /* Bleu clair pour les sous-parties */
            border-radius: 8px;
            padding: 20px;
        }
        .section h2 {
            color: #4CAF50; /* Vert pour les titres principaux */
            font-size: 1.5rem;
            margin-bottom: 10px;
        }
        .section h3 {
            color: #006699; /* Bleu pour les sous-titres */
            font-size: 1.3rem;
            margin-top: 20px;
            margin-bottom: 10px;
        }
